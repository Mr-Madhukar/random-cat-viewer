...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#02050a] text-white relative flex flex-col items-center justify-center p-4 sm:p-8 overflow-hidden selection:bg-cyan-500/30">
      ...
      {/* Scanlines removed — they were sitting at z-50 and darkening all text/content */}

      {/* Main Container */}
      <div className="relative z-10 w-full max-w-5xl">
        {/* Header */}
        <header className="text-center mb-8 sm:mb-12">
          <div className="flex items-center justify-center gap-4 mb-3 opacity-80 text-[10px] sm:text-xs text-blue-300 tracking-[0.5em] font-bold">
          ...
          <p className="mt-4 text-xs sm:text-sm text-cyan-300 tracking-[0.4em] font-semibold uppercase">
